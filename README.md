...
(a) disassembling target CNP structure based on fragmentation patterns;<br> 
(b) building a pseudo-CNP library encompassing all currently reported compounds;<br> 
(c) recognizing target CNP using the pseudo-CNP library;<br> 
